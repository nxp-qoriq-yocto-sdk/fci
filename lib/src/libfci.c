...
//#define FCILIB_PRINT
#define FCILIB_ERR	1
#define	FCILIB_INIT	1
#define	FCILIB_OPEN	1
#define	FCILIB_CLOSE	1
#define	FCILIB_WRITE	1
#define	FCILIB_READ	1
#define FCILIB_DUMP	1
#define FCILIB_CATCH	1
...
static int fci_read(FCI_CLIENT *this_client, struct iovec *iov, int iovlen)
{
	...
	FCILIB_PRINTF(FCILIB_READ,"%s: recvmsg return code %d \n", __func__,rc);
	return rc;	
}
